  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="deposit.php">
            <i class="fa fa-money"></i> <span>Deposit Money</span>
          </a>
        </li>
        <li>
          <a href="registration.php">
            <i class="fa fa-user-plus"></i> <span>Register Client</span>
          </a>
        </li>
        <li>
          <a href="clients.php">
        ...
        <li>
          <a href="bills.php">
            <i class="fa fa-bolt"></i> <span>Bills</span>
          </a>
        </li>
        <li>
          <a href="lostatm.php">
            <i class="fa fa-credit-card"></i> <span>Reported Lost Atm's</span>
          </a>
        </li>
    </section>
    <!-- /.sidebar -->
